...
String apiKey = "PBP1NH9CCBN2J0VC"; //api key for sending data
...
String cmd="AT+CWJAP=\"Iqooneo6\",\"iqooneo6\"";
ser.println(cmd);
delay(1000);
...
BPM = (60000 / runningTotal)*0.3 ; // how many beats can fit into a minute? that's BPM!
